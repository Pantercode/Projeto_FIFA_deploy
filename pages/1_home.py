...
if "data" not in st.session_state:
    try:
        # Lendo o arquivo CSV
        df_data = pd.read_csv(r"C:\Users\marcell.oliveira\Desktop\streamlit\Projeto Streamlit FIFA\Projeto_FIFA_deploy\datasets\CLEAN_FIFA23_official_data.csv", index_col=0)
...
if st.button("Acesse os dados no Kaggle"):
    st.markdown(
        """
        [Clique aqui para acessar os dados no Kaggle](https://www.kaggle.com/datasets/kevwesophia/fifa23-official-datasetclean-data)
        """
    )
